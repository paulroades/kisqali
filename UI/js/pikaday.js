...
(function (root, factory) {
    ...
    renderTitle = function (instance, c, year, month, refYear) {
        var i, j, arr,
            ...
            reverseOrderOfYears = !!opts.reverseOrderOfYears,
    ...
    Pikaday = function (options) {
        ...
        addEvent(self.el, 'touchstart' in document ? 'touchstart' : 'mousedown', self._onMouseDown, true);
    ...
    Pikaday.prototype = {
        ...
        gotoMonth: function (month) {
            if (!isNaN(month)) {
                ...
                var newDate = new Date(this._d);
                newDate.setMonth(this.calendars[0].month);
        ...
        gotoYear: function (year) {
            if (!isNaN(year)) {
                ...
                var newDate = new Date(this._d);
                newDate.setFullYear(this.calendars[0].year);
                this.setDate(newDate);
            }
        },
